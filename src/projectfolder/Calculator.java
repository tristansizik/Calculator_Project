...
public class Calculator {
	...
	/*
	 * TODO: PEMDAS TODO: String parser > reads if starting with operator, carries
	 * over value, if char, give error, if digit, overwrite existing value.
	 */
	public void runCalculator() throws IOException {
		...
		while ((charReader = System.in.read()) != -1) {
			if (charReader == '\n') {
				...
				EquationParser eqp = new EquationParser(userInput);
...
//				sb.setLength(0);
	...
	//NOTE: Only leaving here for reference to work
